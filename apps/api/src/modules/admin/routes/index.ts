...
import { createTenantSchema, updateTenantSchema } from "../validators/tenant.schemas";
...
adminRouter.post("/tenants", validateBody(createTenantSchema), createTenant);
...
adminRouter.put("/tenants/:identifier", validateBody(updateTenantSchema), updateTenant);
